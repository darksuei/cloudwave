...
export function SignUp() {
  ...
  return (
    <div className='w-full h-screen bg-slate-300 flex items-center justify-center'>
      <form
        className='bg-white rounded-2xl p-6 flex flex-col items-center gap-y-5 w-11/12 md:w-5/12 shadow-md'
        method='POST'
      ...
      >
        <div className='text-center'>
          ...
          <p className='text-gray-500 mt-3 text-xs'>
            Let's get started by creating a free account just for you !!!
          </p>
        </div>
        <div className='w-full flex flex-col gap-y-5'>
          ...
          <div className='flex flex-col items-center gap-y-3 mt-3'>
            <button
              type='submit'
              className={`w-6/12 bg-slate-800 hover:bg-slate-600 text-white py-2.5 h-10 px-6 rounded-md transition text-sm flex items-center justify-center ${
