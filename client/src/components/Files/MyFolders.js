  ...
  return (
    <div className="flex flex-col w-11/12 md:w-11/12 gap-y-5">
      ...
      <div className="w-full">
        ...
        >
          <span className="md:inline hidden"><i className="fas fa-folder-open fa-4x text-indigo-500"></i></span>
          <span className="md:hidden inline"><i className="fas fa-folder-open text-6xl text-indigo-500"></i></span>
