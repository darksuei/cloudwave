  ...
  return (
    <div className="flex justify-center items-center py-5 relative">
      ...
      >
        ...
        ></i>
        <div className="rounded-full bg-black p-1 absolute right-0 bottom-1 flex items-center justify-center opacity-70">
          <i className="fas fa-pen text-gray-100 text-xs cursor-pointer opoacity-100"></i>
        </div>
      </div>
    </div>
  );
