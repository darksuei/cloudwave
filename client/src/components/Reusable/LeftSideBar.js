      ...
      <nav className="flex w-2/12 bg-blue-700 text-white text-sm font-semibold relative h-screen">
        <ul className="flex flex-col w-full relative">
          ...
          <div>
            ...
            <a href='/files'><li className={`${Location.location === 'shared'? 'bg-blue-900': ''} px-12 py-4 flex items-center gap-x-2 rounded-r-2xl hover:bg-blue-800`}><div className='p-1 w-5'><i className="fas fa-share-alt"></i></div>My Files</li></a>
